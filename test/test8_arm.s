...
.Lfunc_end4:
	...
	.code	16                      @ @_ZN9bitvector3addEDv32_bS0_
	.thumb_func
_ZN9bitvector3addEDv32_bS0_:
	.fnstart
@ %bb.0:                                @ %entry
	.save	{r4, r5, r6, r7, lr}
	push	{r4, r5, r6, r7, lr}
...
.Lfunc_end5:
	...
	.code	16                      @ @_ZN9bitvector3subEDv32_bS0_
	.thumb_func
_ZN9bitvector3subEDv32_bS0_:
	.fnstart
@ %bb.0:                                @ %entry
	.save	{r4, r5, r6, r7, lr}
	push	{r4, r5, r6, r7, lr}
...
.Ltmp29:
	b	.LBB10_16
.LBB10_12:                              @ %lpad.i.i191
.Ltmp24:
	b	.LBB10_16
.LBB10_13:                              @ %lpad.i.i173
.Ltmp19:
	b	.LBB10_16
.LBB10_14:                              @ %lpad.i.i155
.Ltmp14:
	b	.LBB10_16
.LBB10_15:                              @ %lpad.i.i137
.Ltmp9:
...
.Lcst_begin3:
	...
	.uleb128 .Lfunc_end12-.Ltmp53   @   Call between .Ltmp53 and .Lfunc_end12
	.byte	0                       @     has no landing pad
	.byte	0                       @   On action: cleanup
.Lcst_end3:
	.p2align	2
